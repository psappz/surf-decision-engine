...
TRANSLATIONS = {
 ...
 'de': {
  ...
  'morning':'Morgens','midday':'Mittags','evening':'Abends','session':'Session','surf_call':'Surf Call','estimated_breaking':'Geschätzte brechende Wellenhöhe','swell':'Swell','wind':'Wind','tide':'Tide','water_temp':'Wassertemperatur','newest_data':'Neueste Quelldaten','inspect_peak':'Peak ansehen','no_recommendation':'Keine Empfehlung verfügbar.',
